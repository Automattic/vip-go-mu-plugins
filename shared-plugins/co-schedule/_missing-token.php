                    ...
                    <div class="cos-plugin-inner">
                        ...
                        <div class="cos-plugin-body">
                            <div class="well text-center">
                                <p><strong>Uh oh! It looks like your CoSchedule token is not set. Please <a href="mailto:support@coschedule">contact support</a> for assistance.</strong></p>
                                <p><a href="http://coschedule.com/" target="_blank">Learn More About CoSchedule</a> | <a href="http://coschedule.com/training-articles/how-do-i-install-the-coschedule-wordpress-plugin" target="_blank">How To Install CoSchedule</a></p>
                            </div>
                        </div>
                    </div>
                </div>
