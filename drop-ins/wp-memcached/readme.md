...
This plugin aims to have full compatibility with the wp-memcached plugin, and you can do those first two steps and call it a day. It will work seamlessly as a replacement. Will even keep using the same cache keys/values that are already stored.
