...
class HealthCommand extends \WPCOM_VIP_CLI_Command {
	...
	public function validate_contents( $args, $assoc_args ) {
		...
		$results = $health->validate_index_posts_content( $assoc_args['start_post_id'], $assoc_args['last_post_id'], $assoc_args['batch_size'], $assoc_args['max_diff_size'], isset( $assoc_args['silent'] ), isset( $assoc_args['inspect'] ), isset( $assoc_args['do-not-heal'] ) );
