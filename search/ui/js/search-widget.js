var vipSearchModule = function () {
	var i,
		j,
		checkboxes,
		filter_list = document.querySelectorAll( '.vip-search-filters-widget__filter-list' );
...
if ( document.readyState === 'interactive' || document.readyState === 'complete' ) {
	...
	document.addEventListener( 'DOMContentLoaded', vipSearchModule );
}
