 ...
 * within `wp-content` and attempts to write to a `wp-content/` path,
 * which will fail. This fix uses the plugin's wpcf7_upload_dir filter to
 * override the directory generated by the plugin's wpcf7_upload_dir() function.
 *
