 ...
 * @since 3.12.0
 */
class Tracks_Event_Builder implements JsonSerializable {
	/**
	 * Event name regex.
	 */
	 ...
	 * @return Tracks_Event The resulting event object with processed properties.
	 */
	protected static function process_properties(
		...
		$event = static::sanitize_properties_array( $event_properties );
	 ...
	 * environment.
	 *
	 * @param Tracks_Event $event The event to annotate with identity information.
	 * @return Tracks_Event The new event object including identity information.
	 */
	protected static function set_user_properties( Tracks_Event $event ): Tracks_Event {
	 ...
	 *
	 * @param Tracks_Event|self $event Event object to validate.
	 * @return ?WP_Error null if validation passed, error otherwise.
	 */
	protected static function get_event_validation_result( Tracks_Event $event ): ?WP_Error {
	 ...
	 * @return Tracks_Event The sanitized object.
	 */
	protected static function sanitize_properties_array( array $event_properties ): Tracks_Event {
		$result = new Tracks_Event();
