...
class AgentforceIntegration extends Integration {
	...
	public function is_loaded(): bool {
		return defined( 'VIP_AGENTFORCE_FILE' );
	}
	...
	public function load(): void {
		...
		// Get all the entries in the path of WPVIP_MU_PLUGIN_DIR/vip-integrations/vip-agentforce-<version>/
		...
		$load_path               = WPVIP_MU_PLUGIN_DIR . '/vip-integrations/' . $selected_version_folder . '/vip-agentforce.php';
	...
	public function get_versions() {
		return get_available_versions( WPVIP_MU_PLUGIN_DIR . '/vip-integrations/', 'vip-agentforce', 'vip-agentforce.php' );
	}
