...
class API_Client_Test extends \WP_UnitTestCase {
	...
	public function test__is_file__validate_request() {
		...
		$this->assertEquals( 'https://files.go-vip.co/file.jpg', $actual_http_request['url'], 'API URL not as expected' );
		$this->assertEquals( 'GET', $actual_http_request['args']['method'], 'Wrong method provided' );
